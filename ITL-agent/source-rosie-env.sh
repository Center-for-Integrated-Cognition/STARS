# Initializes environment variables, aliases, and shell completions for the Rosie project
# in the current directory

# Surprisingly tricky! https://stackoverflow.com/a/63072463/474819
THISDIR=$(realpath $(dirname ${BASH_SOURCE[0]:-$0}))

export ROSIE_HOME=$THISDIR

echo -e "\e[93mLoading Rosie development environment from $ROSIE_HOME\e[0m"
...
build_rosie() {
    "$ROSIE_HOME/tools/scripts/build_rosie.sh"
}
...
build_rosie_tools(){
    "$ROSIE_HOME/tools/scripts/build_rosie_tools.sh"
}
