...
public class Palette
{
     ...
     */
    public static class diverging_brewer0
    {
        // Reddish to bluish
    ...
    /** Another brewer color class. More suited to "goodness" heatmap work.
     *  Not colorblind friendly!
     **/
    public static class diverging_brewer1
    {
        public static Color red          = new Color( 165,   0,  38);
        public static Color redorange    = new Color( 215,  48,  39);
        public static Color tangerine    = new Color( 244, 109,  67);
        ...
        public static Color goldenrod    = new Color( 255, 224, 144);
        public static Color lightyellow  = new Color( 255, 255, 191);
        public static Color yellowgreen  = new Color( 217, 239, 139);
        public static Color greenyellow  = new Color( 166, 217, 106);
        public static Color green        = new Color( 102, 189,  99);
        public static Color kellygreen   = new Color(  26, 152,  80);
        public static Color darkgreen    = new Color(   0, 104,  55);
     ...
     */
    public static class qualitative_brewer0
    {
    ...
    /** Color class designed such that no invididual color draws the eye more
     *  than any other. This set is print friendly, though not colorblind safe,
     *  and provides a brighter, more vibrant set of colors as
     *  qualitative_brewer0
     **/
    public static class qualitative_brewer1
    {
        public static Color red     = new Color( 228,  26,  28);
        public static Color blue    = new Color(  55, 126, 184);
        public static Color green   = new Color(  77, 175,  74);
        public static Color purple  = new Color( 152,  78, 163);
        public static Color orange  = new Color( 255, 127,   0);
        public static Color yellow  = new Color( 255, 255,  51);
        public static Color brown   = new Color( 166,  86,  40);
        public static Color pink    = new Color( 247, 129, 191);
    ...
    public static List<Color> listAll()
    {
        ...
        list.addAll(diverging_brewer0.listAll());
        list.addAll(diverging_brewer1.listAll());
        list.addAll(qualitative_brewer0.listAll());
        list.addAll(qualitative_brewer1.listAll());
    ...
    public static void main(String[] args)
    {
        ...
        {
            VisWorld.Buffer vb = vw.getBuffer("diverging_brewer0");

            vb.addBack(new VisLighting(false,
                                       LinAlg.translate(7.0, -2.0, 0),
                                       LinAlg.scale(0.002),
                                       new VzText(VzText.ANCHOR.BOTTOM_LEFT,
                                                  "<<monospaced-128>>Diverging Brewer 0")));
            List<Color> list = diverging_brewer0.listAll();
            for (int i = 0; i < list.size(); i++) {
                vb.addBack(new VisLighting(false,
        ...
        {
            VisWorld.Buffer vb = vw.getBuffer("diverging_brewer1");

            vb.addBack(new VisLighting(false,
                                       LinAlg.translate(0.0, -5.0, 0),
                                       LinAlg.scale(0.002),
                                       new VzText(VzText.ANCHOR.BOTTOM_LEFT,
                                                  "<<monospaced-128>>Diverging Brewer 1")));
            List<Color> list = diverging_brewer1.listAll();
            for (int i = 0; i < list.size(); i++) {
                vb.addBack(new VisLighting(false,
                                           LinAlg.translate(0.5 + i%6, -5.5-i/6, 0),
                                           new VzRectangle(1, 1,
                                                           new VzMesh.Style(list.get(i)))));
            }
        ...
        {
            VisWorld.Buffer vb = vw.getBuffer("qualitative_brewer0");

            vb.addBack(new VisLighting(false,
                                       LinAlg.translate(7.0, -5.0, 0),
                                       LinAlg.scale(0.002),
                                       new VzText(VzText.ANCHOR.BOTTOM_LEFT,
                                                  "<<monospaced-128>>Qualitative Brewer 0")));
            List<Color> list = qualitative_brewer0.listAll();
            for (int i = 0; i < list.size(); i++) {
                vb.addBack(new VisLighting(false,
        ...
        {
            VisWorld.Buffer vb = vw.getBuffer("qualitative_brewer1");

            vb.addBack(new VisLighting(false,
                                       LinAlg.translate(0.0, -8.0, 0),
                                       LinAlg.scale(0.002),
                                       new VzText(VzText.ANCHOR.BOTTOM_LEFT,
                                                  "<<monospaced-128>>Qualitative Brewer 1")));
            List<Color> list = qualitative_brewer1.listAll();
            for (int i = 0; i < list.size(); i++) {
                vb.addBack(new VisLighting(false,
                                           LinAlg.translate(0.5 + i%5, -8.5-i/5, 0),
                                           new VzRectangle(1, 1,
                                                           new VzMesh.Style(list.get(i)))));
            }
            vb.swap();
...

        {
            ...
            for (int i = 0; i < list.size(); i++) {
                vb.addBack(new VisLighting(false,
                                           LinAlg.translate(7.5 + i%6, -8.5-i/6, 0),
                                           new VzRectangle(1, 1,
                                                           new VzMesh.Style(list.get(i)))));
            }
...

        {
            ...
            for (int i = 0; i < list.size(); i++) {
                vb.addBack(new VisLighting(false,
                                           LinAlg.translate(0.5 + i%6, -11.5-i/6, 0),
                                           new VzRectangle(1, 1,
                                                           new VzMesh.Style(list.get(i)))));
            }
