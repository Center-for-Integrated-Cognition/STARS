...
class Backpack(SimObject):
    door = "not-open1"
    cat = "backpack1"
    rgb = [ 0, 0, 0 ]
    #def_props = ('receptacle')
...
class Drawer2(Shelves):  
    door = "not-open1"
    cat = "drawer1"
    #rgb = [ 94, 76, 28 ]

class Cabinet2(Shelves):  
    door = "not-open1"
    cat = "cabinet1"
    rgb = [ 198, 198, 193 ]
