...
def object_to_simple_str(obj_id):
    ...
    #empty messhall?
    #words.append(preds_id.GetChildString("contents1"))
    words.append(preds_id.GetChildString("property"))
    words.append(preds_id.GetChildString("color"))
    words.append(preds_id.GetChildString("material"))
