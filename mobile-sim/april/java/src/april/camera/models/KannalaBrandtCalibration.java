...
public class KannalaBrandtCalibration implements Calibration, ParameterizableCalibration
{
    ...
    public String getCalibrationString()
    {
        ...
        s = String.format("%s            // Parameters defined in:\n", s);
        s = String.format("%s            //   A generic camera model and calibration\n", s);
        s = String.format("%s            //   method for conventional, wide-angle,\n", s);
        s = String.format("%s            //   and fish-eye lenses\n", s);
        s = String.format("%s            // by J. Kannala and S.S. Brandt\n", s);
