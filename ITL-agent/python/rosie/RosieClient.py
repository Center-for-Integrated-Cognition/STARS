...
from rosie.lm import LMConnector
...
class RosieClient(SoarClient):
    ...
    def __init__(self, print_handler=None, config_filename=None, sim_clock=True, **kwargs):
        ...
        # If use_lm_connector = True, add a LMConnector
        if self.use_lm_connector:
            self.add_connector("language_model", LMConnector(self))
    ...
    def _apply_settings(self):
        ...
        self.use_lm_connector = self._parse_bool_setting("use_lm_connector", True)
